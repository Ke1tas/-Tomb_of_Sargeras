...
class SortingBenchmark:
    ...
    def run_benchmarks(self,array_size:int=100)->None:
        ...
        algorithms={"BubbleSort":sorter.BubbleSort,"QuickSort":sorter.quickSort,"MergeSort":sorter.mergeSort,"HeapSort":sorter.heapSort,"InsertionSort":sorter.insertionSort,"SelectionSort":sorter.selectionSort,"ShellSort":sorter.shellSort,"CocktailSort":sorter.cocktailSort,"CombSort":sorter.combSort,"GnomeSort":sorter.gnomeSort}
